...
async function main() {
  ...
  if (hre.network.name === "holesky") {
    console.log(
      `   Token: https://holesky.etherscan.io/address/${tokenAddress}`
    );
    console.log(
      `   ICO:   https://holesky.etherscan.io/address/${tokenICOAddress}`
    );
    ...
    console.log(
      `   ICO:   https://sepolia.etherscan.io/address/${tokenICOAddress}`
    );
  } else if (hre.network.name === "arc_testnet") {
    console.log(
      `   Token: https://arc-testnet.basescan.org/address/${tokenAddress}`
    );
